            ...
            <div className="bg-white rounded-2xl ring-1 ring-slate-900/5 shadow-sm p-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    <select
                        ...
                        className="px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 cursor-pointer"
                    >
                    ...
                    <div className="flex items-center gap-2 flex-1">
                        <input type="date" value={fromDate} onChange={(e) => setFromDate(e.target.value)}
                            className="flex-1 px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 cursor-pointer" />
