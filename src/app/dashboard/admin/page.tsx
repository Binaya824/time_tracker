...
export default async function AdminDashboard() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      {/* ── Page header — centered on mobile, left on sm+ ── */}
      <div className="mb-6 sm:mb-8 text-center sm:text-left">
        <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Admin Dashboard</h1>
        <p className="text-slate-500 mt-1 text-sm">Welcome back, {authUser.name}</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-slate-900 text-sm sm:text-base">Recent Projects</h2>
            <Link
        ...
        {/* Quick Actions */}
        <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
          <h2 className="font-semibold text-slate-900 mb-4 text-sm sm:text-base">Quick Actions</h2>
          <div className="space-y-3">
            <Link
